...
public class AvisClient {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "avisClient_seq_gen")
    @SequenceGenerator(name = "avisClient_gen", sequenceName = "avisClient_seq", allocationSize = 1)
    private Long id;
